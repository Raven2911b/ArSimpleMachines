...
public class ElectricArcFurnaceRecipe extends MachineRecipe {
    ...
    public ElectricArcFurnaceRecipe(ResourceLocation id,
        ...
        super(id, itemInputs, itemTags, fluidInputs, itemOutputs, fluidOutputs, processingTime, energyPerTick);
    }

    @Override
    public net.minecraft.world.item.crafting.RecipeSerializer<?> getSerializer() {
        return ModRecipeTypes.ELECTRIC_ARC_FURNACE_SERIALIZER;
    }

    @Override
    public net.minecraft.world.item.crafting.RecipeType<?> getType() {
        return ModRecipeTypes.ELECTRIC_ARC_FURNACE_TYPE;
    }
